...
const PostAnalytics = () => {
    ...
    const renderFbTableData = () => {
        ...
        return (
            <tbody className="bg-gray-200">
                ...
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block" src={like}/> <span>Likes</span></th>
                    <td className="px-4 py-2 ">{fbStats.likes}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block" src={love}/> <span>Love Reaction</span></th>
                    <td className="px-4 py-2 ">{fbStats.love}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block" src={wow}/> <span>Wow Reaction</span></th>
                    <td className="px-4 py-2 ">{fbStats.wow}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block" src={sad}/> <span>Sorry Reaction</span></th>
                    <td className="px-4 py-2 ">{fbStats.sorry}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block" src={haha} /> <span>Haha Reaction</span></th>
                    <td className="px-4 py-2 ">{fbStats.haha}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block" src={angry}/> <span>Anger Reaction</span></th>
    ...
    const renderYtTableData = () => {
        return (
            <tbody className="bg-gray-200">
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block h-5" src={views}/> <span>View Count</span> </th>
                    <td className="px-4 py-2 ">{ytStats.view_count}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block" src={ytLike}/> <span>Likes</span> </th>
                    <td className="px-4 py-2 ">{ytStats.like_count}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block w-5" src={dislike}/> <span>Dislikes</span> </th>
                    <td className="px-4 py-2 ">{ytStats.dislike_count}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block w-5" src={favorite}/> <span>Favorite Count</span> </th>
                    <td className="px-4 py-2 ">{ytStats.favorite_count}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block h-5" src={comment}/> <span>Comments</span> </th>
    ...
    const renderTwTableData = () => {
        return (
            <tbody className="bg-gray-200">
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block h-5" src={quote}/> <span>Quotes</span> </th>
                    <td className="px-4 py-2 ">{twStats.quote_count}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block w-5" src={reply}/> <span>Replies</span> </th>
                    <td className="px-4 py-2 ">{twStats.reply_count}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block h-5" src={retweet}/> <span>Retweets</span> </th>
                    <td className="px-4 py-2 ">{twStats.retweet_count}</td>
                </tr>
                <tr className="bg-white border-4 border-gray-200">
                    <th className="px-4 py-2 flex justify-start space-x-4"><img className="inline-block h-5" src={twFav}/> <span>Favorites</span> </th>
    ...
    const noSocialNwPost = () => {
        return (
            <div className="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md m-4" role="alert">
                <div className="flex">
                    <div className="py-1"><svg className="fill-current h-6 w-6 text-teal-500 mr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm12.73-1.41A8 8 0 1 0 4.34 4.34a8 8 0 0 0 11.32 11.32zM9 11V9h2v6H9v-4zm0-6h2v2H9V5z"/></svg></div>
                    <div>
                        <p className="font-bold">This post has not been published in any social network yet</p>
                        <p className="text-sm">Analytics will show up here once it's been published.</p>
                    </div>
                </div>
            </div>
        )
	...
	return (
		<div className='flex flex-col px-4 py-8'>
			...
			<div className={getLayoutStyle()}>
				<div className={showStats(onFb) + getComponentsStyle() + ' bg-indigo-200'}>
				...
				<div className={showStats(onTw) + getComponentsStyle() + ' bg-blue-200'}>
